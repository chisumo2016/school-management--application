        ...
        <div class="row content registration-form">
            <div class="col-12 pl-0 pr-0 ">
                <div class="form-group">
                    <div class="col-sm-12">
                        <h4 class="text-center font-weight-bold font-italic mt-3">Manage Header and Footer Edit</h4>
                    </div>
                </div>
                <form method="POST" action="{{ route('header-and-footer-update') }}" enctype="multipart/form-data" autocomplete="off" class="form-inline" >
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="mobile" type="text" class="col-sm-9 form-control" name="mobile" value="{{ $headerFooter->mobile }}" placeholder="Enter your Mobile No:" required>
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="address" type="text" class="col-sm-9 form-control @error('address') is-invalid @enderror " name="address" value="{{ $headerFooter->address }}" placeholder=" Address" required>
                    ...
                    <div class="form-group col-12 mb-3">
                        ...
                        <input id="copyright" type="text" class="col-sm-9 form-control @error('copyright') is-invalid @enderror " name="copyright" value="{{ $headerFooter->copyright }}" placeholder=" Copyright" required>
