                ...
                <form action=" {{ route('update-slide') }}"   method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive p-1">
                        <table id="" class="table table-striped table-bordered dt-responsive nowrap text-center" style="width: 100%;">
                            <tr><td><img src="{{ asset('/') }}{{$slide->slide_image}}" alt="" id="image_show" style="max-width: 400px"> </td></tr>
                            <tr>
                                <td>
                                    <div class="input-group">
                                        <div class="custom-file">
                                            <input  type="file" class="custom-file-input"  name="slide_image" id="slide_image" onchange="showImage(this,'slider_show')">
                                ...
                                <td>
                                    <div class="form-group row  mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input id="slide_title" type="text" class="col-sm-9 form-control" name="slide_title" value="{{ $slide->slide_title }}" placeholder="Image Title" required>
                            ...
                            <tr>
                                <td>
                                    <div class="form-group  row mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            <input id="slide_description" type="text" class="col-sm-9 form-control" name="slide_description" value="{{ $slide->slide_description }}" placeholder="Image Description" required>
                                    ...
                                    <div class="form-group  row mb-0">
                                        ...
                                        <div class="col-sm-9 text-left">
                                            <div class="form-check col-form-label">
                                                <input type="radio" class="form-check-input" name="status" value="1"  {{ $slide->status == 1 ? 'checked'  : ''}} >
                                                <label for="" class="form-check-label">Published</label>
                                            </div>

                                            <div class="form-check col-form-label">
                                                <input type="radio" class="form-check-input" name="status" value="2" {{ $slide->status == 2 ? 'checked'  : ''}}>
