                ...
                <form action=" {{ route('class-save') }}"   method="post" enctype="multipart/form-data">
                    ...
                    <div class="table-responsive p-1">
                        <table id="" class="table table-striped table-bordered dt-responsive nowrap text-center" style="width: 100%;">
                                ...
                                <td>
                                    <div class="form-group row  mb-0">
                                        ...
                                        <div class="col-sm-9">
                                            ...
                                            <input id="class_name" type="text" class="col-sm-9 form-control" name="class_name" value="{{ old('class_name') }}" placeholder="Enter Class Name" required>
                            ...
                            <tr>
                                <td>
                                    <button class="btn btn-block my-btn-submit">Add Class</button>
                                </td>
                            </tr>
